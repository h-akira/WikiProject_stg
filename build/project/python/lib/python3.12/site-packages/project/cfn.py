    ...
    Properties:
      DistributionConfig:
        ...
        - ConnectionTimeout: 10
          ...
          DomainName: !Sub
            "${{MyApiGateway{apigw_index1}}}.execute-api.{region}.amazonaws.com"
          OriginShield:
            Enabled: false
          OriginPath: "/stage-01"
          Id: !Sub
        ...
        - ConnectionTimeout: 10
          ...
          ConnectionAttempts: 3
          DomainName: !Sub
            "${{MyApiGateway{apigw_index2}}}.execute-api.{region}.amazonaws.com"
          OriginShield:
            Enabled: false
          OriginPath: "/stage-01"
          Id: !Sub
...
"""
  def gen_kwargw_CloudFront(self):
    kwargs = {
      "apigw_index1": self.apigw2index(self.settings.AWS["API"]["gateways"][0]["name"]),
      "apigw_index2": self.apigw2index(self.settings.AWS["API"]["gateways"][1]["name"]),
