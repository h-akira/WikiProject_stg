const c = document.getElementById("share");
const d = document.getElementById("share_edit_permission");
const shareEditPermission = document.getElementById("share-edit-permission-p");
const shareCode = document.getElementById("share-code-p");
// ページ読み込み時に実行
